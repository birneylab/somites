...
knitr::include_graphics(here::here("book/figs/somites/grm_man_0.8.png"), auto_pdf = T)
```
...
#| message: false
#| warning: false
#| fig.cap = 'Significant 5-kb bin ranges for period intercept below the minimum p-value from 10 permutations.'
...
```{r ko-period, echo = F, fig.cap = '(ref:ko-period)', out.width='100%'}
knitr::include_graphics(here::here("book/figs/somites/ko_results.png"), auto_pdf = T)
```
