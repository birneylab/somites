...
#| fig.cap: 'Proportion of homozygous SNPs within 5 kb bins in the *Cab* F~0~ generation genome (*green*), and number of SNPs in each bin (*yellow*). Code set out in `rule circos_homozygosity` in https://github.com/brettellebi/somites/blob/master/workflow/rules/04_trio_homozygosity.smk.'
...
#| fig.cap: 'Proportion of homozygous SNPs within 5 kb bins in the *Kaga* F~0~ generation genome (*red*), and number of SNPs in each bin (*yellow*). Code set out in `rule circos_homozygosity` in https://github.com/brettellebi/somites/blob/master/workflow/rules/04_trio_homozygosity.smk.'
...
#| fig.cap: 'Proportion of homozygous SNPs within 5 kb bins in the *Kaga* F~0~ generation genome when aligned to the *HNI* reference (*red*), and number of SNPs in each bin (*yellow*). Code set out in `rule circos_homozygosity` in https://github.com/brettellebi/somites/blob/master/workflow/rules/04_trio_homozygosity.smk.'
#| out.width: '100%'
